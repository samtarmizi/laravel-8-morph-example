...
<html lang="en">
<head>
  <title>8PI 8log | Blog for Everyone</title>

  <meta charset="utf-8">
  <!--[if IE]><meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
  <meta name="description" content="Blog for Everyone, Every Devices">
...
<body>
  ...
  <main class="main-wrapper">
          ...
          <div class="flex-parent">
            ...
            <div class="nav__header">
              ...
              <a href="index.html" class="logo-container flex-child">
                <img class="logo" src="{{ asset('front/img/logo.png') }}" srcset="{{ asset('front/img/logo.png')}} 1x, {{ asset('front/img/logo@2x.png') }} 2x" alt="logo">
              </a>
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      <defs>
        <pattern id="img1" patternUnits="userSpaceOnUse" width="500" height="500">
          <image xlink:href="{{ asset('front/img/hero/hero.jpg') }}" x="50" y="70" width="500" height="500"></image>
        </pattern>
    ...
    <div class="content-wrapper oh">
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="feature box-shadow hover-up hover-line">
                <svg class="feature__icon"><use xlink:href="{{ asset('front/img/icons/orion-svg-sprite.svg#medical-research-1') }}"></use></svg>
            ...
            <div class="col-lg-4">
              <div class="feature box-shadow hover-up hover-line">
                <svg class="feature__icon"><use xlink:href="{{ asset('front/img/icons/orion-svg-sprite.svg#edit-document-1') }}"></use></svg>
            ...
            <div class="col-lg-4">
              <div class="feature box-shadow hover-up hover-line">
                <svg class="feature__icon"><use xlink:href="{{ asset('front/img/icons/orion-svg-sprite.svg#currency-1') }}"></use></svg>
        ...
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
          ...
          <defs>
            <pattern id="img2" patternUnits="userSpaceOnUse" width="600" height="600">
              <image xlink:href="{{ asset('front/img/promo/promo_img_1.jpg') }}" width="600" height="600"></image>
            </pattern>
          </defs>    
        </svg>
            ...
            <div class="col-lg-10">
              ...
              <div id="owl-testimonials" class="owl-carousel owl-theme owl-carousel--arrows-outside">
                ...
                <div class="testimonial clearfix">
                  <img src="{{ asset('front/img/testimonials/1.png') }}" alt="" class="testimonial__img">
                ...
                <div class="testimonial clearfix">
                  <img src="{{ asset('front/img/testimonials/2.png') }}" alt="" class="testimonial__img">
                  <div class="testimonial__info">
                ...
                <div class="testimonial clearfix">
                  <img {{ ('front/img/testimonials/2.png') }}" alt="" class="testimonial__img">
                  <div class="testimonial__info">
                    <span class="testimonial__author">Alexander Samokhin</span>
                    <span class="testimonial__company">DeoThemes</span>
                  </div>
          ...
          <div class="row card-row">
              ...
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <img src="{{ ('front/img/blog/post_1.jpg') }}" class="entry__img" alt="">
                  </a>
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <img src="{{ ('front/img/blog/post_2.jpg') }}" class="entry__img" alt="">
                  </a>
                  <div class="entry__date">
            ...
            <div class="col-lg-4">
              <article class="entry card box-shadow hover-up">
                <div class="entry__img-holder card__img-holder">
                  <a href="single-post.html">
                    <img src="{{ asset('front/img/blog/post_3.jpg') }}" class="entry__img" alt="">
                  </a>
                  <div class="entry__date">
      ...
      <!-- Partners -->
      <section class="section-wrap section-wrap--pb-large bg-gradient" style="background-image: url(front/img/partners/map.png);">
        <div class="container">
          <div class="title-row title-row--boxed text-center">
            ...
            <div class="col-lg-10">
              <div class="row pb-48">
                <div class="col-md col-sm-6">
                  <img src="{{ asset('front/img/partners/1.png') }}" alt="">
                </div>
                <div class="col-md col-sm-6">
                  <img src="{{ asset('front/img/partners/2.png') }}" alt="">
                </div>
                <div class="col-md col-sm-6">
                  <img src="{{ asset('front/img/partners/3.png') }}" alt="">
                </div>
                <div class="col-md col-sm-6">
                  <img src="{{ asset('front/img/partners/4.png') }}" alt="">
                </div>
                <div class="col-md col-sm-6">
                  <img src="{{ asset('front/img/partners/5.png') }}" alt="">
                </div>
              </div>
            </div>
          </div>          
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-md-6">
                <div class="widget widget-address">
                  ...
                  <ul>
                    <li><address>Block G-1-131, Plaza Jelutong
No. 5C, Persiaran Gerbang Utama, Bukit Jelutong, 40150 Shah Alam, Selangor</address></li>
                    <li>
                      <span>Phone: </span>
                      <a href="tel:+1-800-1554-456-123">+60 (10) 222 7576</a>
                    </li>
                    <li>
                      <span>Email: </span>
                      <a href="mailto:admin@tarsoft.co">admin@tarsoft.co</a>
                    </li>
                  </ul>
                </div>
              </div>           
        ...
        <div class="footer__bottom top-divider">
          <div class="container text-center">
            <span class="copyright">
              &copy; 2020 8log 8PI, Made by <a href="https://tarsoft.co">Tarsoft Sdn Bhd</a>
            </span>
          </div>
